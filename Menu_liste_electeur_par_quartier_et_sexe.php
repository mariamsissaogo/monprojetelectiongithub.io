...
<body style="background:white;">
    ...
    <div class="" style="margin-top: 150px">
        <?php
        include("liste_electeur_par_quartier_et_sexe.php");
        ?>
    </div>
...
<script>
    document.querySelector('.btn_imprimer').addEventListener('click', function(){
        document.querySelector('#id_list_deroulante_qs1').style.display = "none";
        ...
        document.querySelector('#id_list_deroulante_qs1').style.marginTop = "0px";
        // document.querySelector('#id_list_deroulante_qs2').style.marginTop = "0px";
        
        window.print();
        document.querySelector('#id_list_deroulante_qs1').style.display = "block";
