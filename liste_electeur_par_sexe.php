...
<body>
  ...
  <form action="" method="post">
      ...
      <center  style="margin-top: 150px;" id="id_list_deroulante">
      ...
      <h3 style="margin-top: 30px;" id="id_titre_tableau">LISTE DES ELECTEURS PAR SEXE </h3>
    </center>
    <table class="table table-bordered border-primary  prime table-responsive" id="first">
      <thead>
        <th>N°</th>
  ...
  <script>
    ...
    document.querySelector('#sexe').addEventListener('change', function() {
      ...
      xhr.open('POST', 'electeur_sexe.php', true);
