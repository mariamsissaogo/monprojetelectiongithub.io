...
<body>
  <form action="" method="post">
    <center style="margin-top: 50px;" id="id_list_deroulante_qs1">
    ...
    <br /><br />
    <center>
      <h3 style="margin-top: 30px;">LISTE DES ELECTEURS PAR QUARTIER ET SEXE </h3>
    </center>
    <table class="table table-bordered border-primary container prime" id="id_titre_tableau_qs">
  ...
  <script>
    ...
    document.querySelector('#sexe').addEventListener('change', function() {
      ...
      xhr.open('POST', 'quartier_sexe.php', true);
      xhr.setRequestHeader('Content-type', 'application/json; charset=UTF-8');
      xhr.send(JSON.stringify(data));
