...
<body style="background:white;">
    ...
    <div class="" style="margin-top: 250px">
        <?php
        include("liste_electeur_Administrateur.php");
        ?>
    </div>
...
<script>
    document.querySelector('.btn_imprimer').addEventListener('click', function(){
        // document.querySelector('#id_list_deroulante_s').style.display = "none";
        document.querySelector('#cl_menu').style.display = "none";
        // document.querySelector('#id_titre_tableau_v').style.marginTop = "0px";
        // document.querySelector('#id_list_deroulante_s').style.marginTop = "0px";
        
        window.print();
        // document.querySelector('#id_list_deroulante_s').style.display = "block";
